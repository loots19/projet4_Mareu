...
import com.e.mareu.adapter.SpinnerAdapter;
...
public class CreateMeeting extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpinnerAdapter mAdapter = new SpinnerAdapter(this, R.layout.spinner_layout, R.id.spinner_roomName, (ArrayList<Room>) mRoomList);
    ...
    private Meeting createMeeting() {
        ...
        if (mSubject.getText().toString().length() == 0 || mMail.getText().length() == 0 || mDisplayTime.getText().toString().length() == 0
            ...
            Toast.makeText(this, R.string.text_label, Toast.LENGTH_SHORT).show();
